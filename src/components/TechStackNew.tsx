...
const techStack: TechItem[][] = [
  ...
  [
    ...
    { name: "Unreal Engine", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/unrealengine/unrealengine-original.svg", url: "https://www.unrealengine.com/en-US/unreal-engine-5" },
